function thirdGame() {
    ...
    updateConditionRemainingFigure();
    ...
    function updateConditionRemainingFigure() {
    ...
    function checkBasket() {
        ...
        if (areFiguresCorrect) {
            ...
            globalCount += pointsEnlarger * pointsForCorrectAnswer;
            ...
            globalCount += pointsEnlarger * pointsForWrongAnswer;
        ...
        stayBtn.innerText = 'Понятно';
        movePopup.style.display = 'none';

        counter.innerText = count;
        movePopup.innerText = 'Закончить игру';
        popupContent.children[1].innerText = 'Вы можете либо закончить' +
            'игру, либо попробовать снова.';
    ...
    function showFailPopup() {
        ...
        popupContent.children[0].innerText =
            'Вы выбрали неверную пару элементов.';
        showPopup();
    }
    ...
    function showSuccessPopup() {
        ...
        popupContent.children[0].innerText =
            'Вы выбрали правильную пару элементов.';
        showPopup();
    }
